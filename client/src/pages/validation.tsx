...
export default function Validation() {
  ...
  const { data: validators = [] } = useQuery({
    ...
    select: (users: any[]) =>
      users.filter(
        (u) =>
          u.role === "validator" || u.role === "manager" || u.role === "admin"
      ),
  });
  ...
  const approveMutation = useMutation({
    mutationFn: (id: string) =>
      apiRequest("POST", `/api/validation-requests/${id}/approve`),
    onSuccess: () => {
  ...
  const rejected7d = requests.filter(
    (r) => r.status === "rejected" && new Date(r.createdAt) >= sevenDaysAgo
  ).length;
  const approved7d = requests.filter(
    (r) => r.status === "approved" && new Date(r.createdAt) >= sevenDaysAgo
  ).length;
  ...
  const getTypeLabel = (type: string) => {
    switch (type) {
      ...
      case "termination":
        return "Résiliation";
      case "manual_amount":
        return "Mise à jour manuelle du montant";
      default:
        return type;
    }
  };
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="list" className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    <Select value={typeFilter} onValueChange={setTypeFilter}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="manual_amount">
                          Mise à jour manuelle du montant
                        </SelectItem>
                      </SelectContent>
                    </Select>
              ...
              {typeFilter === "contract" && (
                <Alert className="mb-6">
                  ...
                  <AlertDescription>
                    <strong>
                      Séparation des rôles pour les validations de contrats :
                    </strong>{" "}
                    le créateur ne peut pas être son propre valideur.
                  </AlertDescription>
                </Alert>
              )}
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell>
                                  <Badge
                                    variant={
                                      getStatusVariant(request.status) as any
                                    }
                                  >
              ...
              <p className="text-xs text-gray-500 mt-4">
                La liste affiche uniquement les demandes visibles selon votre
                rôle et périmètre.
              </p>
            </TabsContent>
            ...
            <TabsContent value="settings" className="space-y-6">
              ...
              <Alert className="mb-6">
                ...
                <AlertDescription>
                  Accès Admin uniquement. Toute modification de règles est
                  tracée.
                </AlertDescription>
              </Alert>
                    ...
                    <SheetTitle>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant={
                              getStatusVariant(selectedRequest.status) as any
                            }
                          >
                  ...
                  <div className="mt-6 space-y-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="mt-3">
                          ...
                          <p className="text-sm mt-1">
                            Extension du périmètre suite à l'ajout de nouveaux
                            services.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {formatDate(
                              selectedRequest.createdAt || new Date()
                            )}
                          </span>
                        </div>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-mono text-xs">
                            TRC-2024-{Math.floor(Math.random() * 10000)}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    {selectedRequest.type === "contract" && (
                      <Alert>
                        <Info className="h-4 w-4" />
                        <AlertDescription>
                          <strong>Contrats:</strong> Rappel de la séparation des
                          rôles (créateur ≠ valideur).
                          <br />
                          <strong>Toutes demandes:</strong> Motif obligatoire en
                          cas de rejet.
                        </AlertDescription>
                      </Alert>
                    )}
                      ...
                      <div className="space-y-4 border-t pt-4">
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="approve" className="text-green-600">
                              Approuver
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="reject" id="reject" />
                            <Label htmlFor="reject" className="text-red-600">
                              Rejeter
                            </Label>
                          </div>
                        </RadioGroup>
          ...
          <Dialog open={showRejectModal} onOpenChange={setShowRejectModal}>
            <DialogContent data-testid="reject-modal">
              <DialogHeader>
                ...
                <DialogDescription>
                  Veuillez indiquer le motif du rejet pour la demande #
                  {selectedRequest?.reference}
                </DialogDescription>
              </DialogHeader>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    const selectedValidator = validators.find(
                      (v: any) => v.id === transferTo
                    );
                    toast({
                      title: "Demande transférée",
                      description: `La demande a été transférée à ${
                        selectedValidator
                          ? selectedValidator.firstName +
                            " " +
                            selectedValidator.lastName
                          : transferTo
                      }`,
                    });
                  }}
          ...
          >
            <DialogContent data-testid="bulk-action-modal">
              <DialogHeader>
                ...
                <DialogDescription>
                  Appliquer une action à {selectedRequests.length} demandes
                  sélectionnées
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <RadioGroup
                  value={bulkAction}
                  onValueChange={(v) => setBulkAction(v as any)}
                >
                  <div className="flex items-center space-x-2">
                  ...
                  onClick={() => {
                    ...
                    toast({
                      ...
                      description: `${
                        ...
                        bulkAction === "approve" ? "approuvées" : "rejetées"
                      }`,
                    });
                  }}
                >
