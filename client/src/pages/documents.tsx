...
export default function Documents() {
    ...
    documentsData.length > 0
      ? documentsData.map((doc: Document) => {
          const contract = contracts.find(
            (c: Contract) => c.id === doc.contract_id
          );
          ...
          return {
            ...
            contractNumber:
              ...
              `CNT-${doc.contract_id?.substring(0, 8) || "NA"}`,
  ...
  const filteredDocuments = documents.filter((doc: any) => {
    ...
    const matchesAuthor =
      authorFilter === "all" || doc.uploadedBy === authorFilter;
            ...
            <CardContent className="p-4">
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-600 bg-gray-100 p-2 rounded">
                  <span className="font-medium">Formats autorisés :</span> PDF,
                  DOCX, XLSX, ODT, JPG, PNG
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-0">
              ...
              <div className="border-t px-4 py-3 flex items-center justify-between text-sm text-gray-600">
                <div>
                  Affichage 1-{filteredDocuments.length} sur{" "}
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setUploadForm({ ...uploadForm, contractId: value })
                    }
                  >
                ...
                <>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm">
                        {selectedDocument.contractNumber} -{" "}
                        {selectedDocument.contractTitle}
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm">
                        {formatDateTime(selectedDocument.uploadDate)}
                      </p>
                    </div>
              ...
              {selectedDocument && (
                <>
                    ...
                    <DialogTitle className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        {(selectedDocument.format === "PDF" ||
                          selectedDocument.format === "JPG" ||
                          selectedDocument.format === "PNG") && (
                          <>
                  ...
                  <div className="mt-4 p-3 bg-gray-50 rounded text-sm text-gray-600">
                    ...
                    <span className="font-medium ml-2">Contrat lié:</span>{" "}
                    {selectedDocument.contractNumber} |
                    <span className="font-medium ml-2">Date d'ajout:</span>{" "}
                    {formatDateTime(selectedDocument.uploadDate)}
                  </div>
                </>
              )}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, mandatory: e.target.checked })
                    }
                  />
