...
export default function Deadlines() {
  ...
  // Calcul des KPIs
  const kpis = {
    j30: deadlines.filter((d) => d.daysRemaining <= 30 && d.daysRemaining > 7)
      .length,
    j7: deadlines.filter((d) => d.daysRemaining <= 7 && d.daysRemaining > 1)
      .length,
    j1: deadlines.filter((d) => d.daysRemaining <= 1 && d.daysRemaining >= 0)
      .length,
  ...
  const filteredDeadlines = deadlines.filter((deadline) => {
    ...
    const matchesBU =
      ...
      deadline.businessUnit === businessUnitFilter;
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <Alert className="mb-6">
            ...
            <AlertDescription>
              Une notification est générée <strong>30 jours avant</strong>{" "}
              l'échéance (valeur paramétrable).
            </AlertDescription>
          </Alert>
            ...
            <CardContent className="p-0">
                      ...
                      {filteredDeadlines
                        ...
                        .map((deadline) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <Badge
                                variant={getDaysVariant(deadline.daysRemaining)}
                              >
                                {deadline.daysRemaining < 0
                                  ? `Retard ${Math.abs(
              ...
              {filteredDeadlines.length > 0 && (
                <div className="border-t px-4 py-3 flex items-center justify-between text-sm text-gray-600">
                  <div>
                    1-
                    {Math.min(parseInt(itemsPerPage), filteredDeadlines.length)}{" "}
            ...
            <DialogContent className="w-[95vw] max-w-[500px] max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="bg-gray-50 p-3 rounded text-sm">
                  ...
                  <p>
                    Période: {periodFilter === "all" ? "Toutes" : periodFilter}
                  </p>
                  <p>
                    Type:{" "}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setDeadlineForm({ ...deadlineForm, businessUnit: v })
                    }
                  >
