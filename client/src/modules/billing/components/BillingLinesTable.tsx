      ...
      <table className="w-full text-sm">
        <thead className="sticky top-0 bg-white border-b">
          <tr className="text-left">
            ...
            <th className="px-4 py-2">Montant TVA</th>
          ...
          {rows.map((l) => {
            ...
            return (
              <tr key={l.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-2">{formatMoney(amountHt)}</td>
                <td className="px-4 py-2">{formatMoney(tvaAmount)}</td>
                <td className="px-4 py-2">{formatMoney(ttcAmount)}</td>
                <td className="px-4 py-2">
