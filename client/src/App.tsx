...
// 👉 nouveau module contrats (cockpit ISO dashboard)
...
// 👉 page création contrat (écran plein)
...
function Router() {
  ...
  return (
    <div className="kly-page">
      <TutorialOverlay />
      <AppLayout>
        <Switch>
          <Route path="/" component={Dashboard} />

          {/* Contrats - liste principale (cockpit ISO Dashboard) */}
          ...
          {/* Création de contrat - écran dédié (doit être AVANT /contracts/:id) */}
          <Route path="/contracts/new">
            <ProtectedRoute route="/contracts/new">
              <ContractCreatePage />
            </ProtectedRoute>
          </Route>

          {/* Contrat - page de détail plein écran */}
          <Route path="/contracts/:id">
            <ProtectedRoute route="/contracts/:id">
              <ContractDetailPage />
            </ProtectedRoute>
          </Route>
          ...
          <Route path="/clients/:id">
            <ProtectedRoute route="/clients/:id">
              <ClientDetailPage />
            </ProtectedRoute>
          </Route>
