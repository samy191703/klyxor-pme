          ...
          >
            <CardContent className="p-4 sm:p-5 lg:p-6">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 ${colors.iconBg} rounded-lg flex items-center justify-center`}>
                  <Icon className={`${colors.iconText} w-5 h-5 sm:w-6 sm:h-6`} />
                </div>
                <span className={`text-xl sm:text-2xl font-bold ${colors.numberText}`} data-testid={`kpi-value-${config.key}`}>
                  {value}
                </span>
              </div>
