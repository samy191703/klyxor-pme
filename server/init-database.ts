...
async function initializeDatabase() {
  ...
  try {
    ...
    const contractAmendments = await db
      .insert(amendments)
      .values([
        {
          ...
          description:
            "Ajout de 5 éoliennes supplémentaires sur le site existant",
          status: "active",
          effectiveDate: new Date("2024-09-01"),
          originalAmount: "45000000",
          newAmount: "52000000",
          impactDescription:
            "Augmentation de la capacité de production de 120MW à 140MW",
        ...
        },
        {
          ...
          description:
            "Changement de la formule d'indexation suite évolution réglementaire",
          status: "pending_signature",
          effectiveDate: new Date("2025-01-01"),
          originalAmount: "58000000",
          newAmount: "58000000",
          impactDescription:
            "Passage de Type 2.A à Type 2.B pour adaptation CRE8",
        ...
        },
        {
          ...
          newAmount: "240000000",
          impactDescription:
            "Extension jusqu'en 2044 avec ajustement tarifaire",
          requestedBy: marie.id,
          approvedBy: jean.id,
        ...
        },
        {
          ...
          description:
            "Extension du périmètre PPA pour nouveau datacenter Google",
          status: "active",
      ...
      .values([
        {
          ...
          daysRemaining: Math.floor(
            (new Date("2027-12-31").getTime() - new Date().getTime()) /
              (1000 * 60 * 60 * 24)
          ),
          businessUnit: "ENGIE Global Energy Management",
        ...
        },
        {
          ...
          daysRemaining: Math.floor(
            (new Date("2024-07-01").getTime() - new Date().getTime()) /
              (1000 * 60 * 60 * 24)
          ),
          businessUnit: "ENGIE Solutions France",
        ...
        },
        {
          ...
          daysRemaining: Math.floor(
            (new Date("2025-01-01").getTime() - new Date().getTime()) /
              (1000 * 60 * 60 * 24)
          ),
          businessUnit: "ENGIE Green",
          notificationSent: false,
        },
        {
          ...
          daysRemaining: Math.floor(
            (new Date("2024-12-15").getTime() - new Date().getTime()) /
              (1000 * 60 * 60 * 24)
          ),
          businessUnit: "ENGIE Solutions France",
          notificationSent: false,
      ...
      .values([
        {
          ...
          message:
            "Le contrat de fourniture gaz arrive à échéance dans 3 ans. Prévoir renouvellement.",
          isRead: false,
          severity: "medium",
        ...
        },
        {
          ...
          message:
            "L'avenant AVN-2024-002 est en attente depuis plus de 15 jours",
          isRead: false,
          severity: "high",
          referenceId: contractAmendments[1].id,
        },
